...
```
wget -O /usr/bin/sprov-ui -N --no-check-certificate https://raw.githubusercontent.com/vlanbin/sprov-ui-backup/master/sprov-ui.sh && chmod +x /usr/bin/sprov-ui && sprov-ui
